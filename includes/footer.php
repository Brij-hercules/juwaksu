    ...
    <footer class="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="text-sm leading-relaxed mb-4">
                        Providing premier freehold residential, commercial, and 8% Kisan Quota allotment plots in Wave City, Ghaziabad. Secure your investment in future-ready developments.
                    </p>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="list-unstyled space-y-2 text-sm">
                        <li>
                            <span class="inline-flex items-center gap-1.5 text-xs bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded border border-emerald-500/20">
                                100% Freehold
                            </span>
                        </li>
                        <li>
                            <span class="inline-flex items-center gap-1.5 text-xs bg-amber-500/10 text-amber-400 px-2 py-0.5 rounded border border-amber-500/20">
                                Kisan Allotments
                            </span>
                        </li>
                        <li>
                            <span class="inline-flex items-center gap-1.5 text-xs bg-indigo-500/10 text-indigo-400 px-2 py-0.5 rounded border border-indigo-500/20">
                                Gated Gird
                            </span>
                        </li>
                    </ul>
            ...
            <div class="mt-8 pt-8 border-t border-slate-800/60 text-center text-xs text-slate-600">
                Are you an agent? <a href="crm/login.php" class="text-slate-500 hover:text-brand-gold underline transition">Login to CRM Dashboard</a>
            </div>
        </div>
    </footer>
