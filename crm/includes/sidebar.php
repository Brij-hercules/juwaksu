...
<aside id="crm-sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
        ...
        <?php else: ?>
            ...
            <!-- Leads (Replaced Excel Sheet Dropdown) -->
            <?php if (has_permission('inquiries', 'view')): ?>
                <a href="excel-leads.php"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-100 hover:text-blue-700 transition text-sm font-semibold <?php echo $activePage == 'excel-leads.php' ? 'sidebar-active' : 'text-slate-600'; ?>">
