...
<style>
  ...
  .chart-card:hover { box-shadow: 0 8px 20px rgba(0,0,0,0.12); }
</style>
<div class="max-w-7xl mx-auto my-8">
  <h1 class="text-3xl font-bold text-slate-800 mb-6">CRM Analytics Dashboard</h1>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="chart-card"><h2 class="text-xl font-semibold text-slate-700 mb-4">Leads by Source</h2><canvas id="leadSourceChart"></canvas></div>
    <div class="chart-card"><h2 class="text-xl font-semibold text-slate-700 mb-4">Allotment Type Distribution</h2><canvas id="allotmentChart"></canvas></div>
    <div class="chart-card"><h2 class="text-xl font-semibold text-slate-700 mb-4">Meta Ads Clicks Over Time</h2><canvas id="metaClicksChart"></canvas></div>
    <div class="chart-card"><h2 class="text-xl font-semibold text-slate-700 mb-4">Inquiries per Day</h2><canvas id="inquiriesDayChart"></canvas></div>
  </div>
</div>
