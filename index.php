...
<!-- Hero Banner Section -->
<section class="relative bg-gradient-to-br from-brand-600 via-brand-500 to-indigo-900 text-white py-24 md:py-32 overflow-hidden">
    ...
    <div class="container relative z-10">
        <div class="row align-items-center g-5">
            <!-- Left Column: Copy -->
            <div class="col-lg-7 text-center lg:text-left animate-fade-in-up">
                <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 text-brand-gold border border-amber-500/30 text-xs font-bold uppercase tracking-widest mb-4">
                    <svg class="w-3 h-3 text-brand-gold animate-pulse" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>
                ...
                <p class="text-slate-300 text-lg md:text-xl font-light mb-8 max-w-xl leading-relaxed mx-auto lg:mx-0">
                    Premium freehold residential plots and limited <strong class="text-white font-semibold">8% Kisaan Quota</strong> allotments in Wave City's developed phase. Possession handover, construction-ready.
                </p>
                
                <div class="flex flex-wrap gap-4 justify-center lg:justify-start">
                    <a href="#featured-listings" class="px-8 py-3.5 bg-brand-gold hover:bg-brand-goldDark text-slate-950 font-bold rounded-xl transition duration-300 shadow-xl transform hover:-translate-y-1">
                        Explore Plots
                    </a>
                    <a href="#book-visit" class="px-8 py-3.5 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition duration-300 border border-white/20 backdrop-blur-md">
            ...
            <div class="col-lg-5 animate-fade-in-up delay-200">
                <div class="bg-slate-900/80 backdrop-blur-md border border-slate-700/50 p-6 md:p-8 rounded-3xl shadow-2xl relative">
                    <div class="absolute -top-4 -right-4 bg-rose-600 text-white font-bold text-xs uppercase tracking-widest px-4 py-2 rounded-xl rotate-12 shadow-lg">
                        Best Rates!
                    </div>
...
<section id="featured-listings" class="py-20 bg-white">
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between align-items-end mb-12 scroll-reveal">
            <div>
                <span class="text-brand-gold font-bold uppercase tracking-wider text-xs block mb-1">Highly Recommended</span>
                <h2 class="text-3xl font-black text-slate-800">Featured Properties</h2>
            </div>
            <a href="category.php?slug=residential-plots" class="text-brand-500 font-bold hover:text-brand-gold transition duration-200 flex items-center gap-1">
                View All Plots 
            ...
            <?php else: ?>
                <?php foreach ($featuredProperties as $prop): ?>
                    <div class="col-lg-4 col-md-6 scroll-reveal">
                        <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition duration-300 border border-slate-100 flex flex-col h-full group">
                            ...
                            <div class="relative overflow-hidden aspect-[4/3] bg-slate-100">
                                ...
                                <span class="absolute top-4 right-4 z-10 bg-brand-600/90 backdrop-blur-sm text-white font-semibold text-[10px] uppercase tracking-wider px-3 py-1.5 rounded-full shadow">
